...
print("Convert all the data to TRUE/FALSE - either plans are ok or they are not and do the same analysis for these reduced levels")
...
print("combination of the plans as one observation - iota")
print(iota(list(Sentinel, Negs, Sum, Count, Divzero, Avg), scaledata="n"))
